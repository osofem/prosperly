...
class Prosperly extends events_1.default {
     ...
     */
    constructor(botToken, webhookParams, serverless = false) {
        super();
        _Prosperly_instances.add(this);
        _Prosperly_API_URL.set(this, void 0);
        __classPrivateFieldSet(this, _Prosperly_API_URL, "https://api.telegram.org/bot" + botToken + "/", "f");
        //setup webhook and server for listening
        if (typeof (webhookParams) != 'undefined') {
            //setup webhook
            __classPrivateFieldGet(this, _Prosperly_instances, "m", _Prosperly_setWebhook2).call(this, webhookParams).then(() => {
                if (!serverless) {
                    //webhook successful so setup server
                    __classPrivateFieldGet(this, _Prosperly_instances, "m", _Prosperly_serverSetup).call(this, webhookParams);
                }
            }).catch((error) => {
                //error occured
...
_Prosperly_API_URL = new WeakMap(), _Prosperly_instances = new WeakSet(), _Prosperly_setWebhook2 = function _Prosperly_setWebhook2(contents) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield post(url, form, form.getHeaders());
    });

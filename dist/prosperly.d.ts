...
export default class Prosperly extends Events {
    ...
    * */
     ...
     * */
    sendMessage(contents: SendMessageParams): Promise<any>;
    /**
     * Use this method to forward messages of any kind. Service messages can't be forwarded.
     * @param contents Object of type ForwardMessageParams
     * @return On success Promise of the sent Message is returned.
     * */
    forwardMessage(contents: ForwardMessageParams): Promise<any>;
    /**
     ...
     * @return On success, the Promise of the sent Message is returned.
     */
    sendAudio(contents: SendAudioParams): Promise<any>;
    /**
     * Use this method to send general files
     * @param contents Object of the type SendDocumentParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendDocument(contents: SendDocumentParams): Promise<any>;
    /**
     * Use this method to send video files, Telegram clients support mp4 videos (other formats may be sent as Document)
     * @param contents Object of the type SendVideoParam
     * @return On success, the Promise of the sent Message is returned.
     */
    sendVideo(contents: SendVideoParams): Promise<any>;
    /**
     * Use this method to send animation files (GIF or H.264/MPEG-4 AVC video without sound)
     * @param contents Object of the type SendAnimationParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendAnimation(contents: SendAnimationParams): Promise<any>;
    /**
     ...
     * @return On success, the Promise of the sent Message is returned.
     */
    sendVoice(contents: SendVoiceParams): Promise<any>;
    /**
     * As of v.4.0, Telegram clients support rounded square mp4 videos of up to 1 minute long. Use this method to send video messages.
     * @param contents Object of the type SendVideoNoteParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendVideoNote(contents: SendVideoNoteParams): Promise<any>;
    /**
     ...
     */
    sendMediaGroup(contents: SendMediaGroupParams): Promise<any>;
    /**
     * Use this method to send point on the map.
     * @param contents Object of the type SendLocationParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendLocation(contents: SendLocationParams): Promise<any>;
    /**
     ...
     */
    editMessageLiveLocation(contents: EditMessageLiveLocationParams): Promise<any>;
    /**
     * Use this method to stop updating a live location message before live_period expires.
     * @param contents Object of the type StopMessageLiveLocationParams
     * @return On success, if the edited message is not an inline message, the Promise the edited Message is returned, otherwise Promise of True is returned.
     */
    stopMessageLiveLocation(contents: StopMessageLiveLocationParams): Promise<any>;
    /**
     * Use this method to send information about a venue.
     * @param contents Object of the type SendVenueParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendVenue(contents: SendVenueParams): Promise<any>;
    /**
     * Use this method to send phone contacts.
     * @param contents Object of the type SendContactParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendContact(contents: SendContactParams): Promise<any>;
    /**
     * Use this method to send a native poll.
     * @param contents Object of the type SendPollParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendPoll(contents: SendPollParams): Promise<any>;
    /**
     * Use this method to send an animated emoji that will display a random value.
     * @param contents Object of the type SendDiceParams
     * @return On success, the Promise of the sent Message is returned.
     */
    sendDice(contents: SendDiceParams): Promise<any>;
    /**
     ...
     */
    sendChatAction(contents: SendChatActionParams): Promise<any>;
    /**
     ...
     */
    getUserProfilePhotos(contents: GetUserProfilePhotosParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    banChatMember(contents: BanChatMemberParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    unbanChatMember(contents: UnbanChatMemberParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    restrictChatMember(contents: RestrictChatMemberParams): Promise<any>;
    /**
     * Use this method to promote or demote a user in a supergroup or a channel. The bot must be an administrator in the chat for this to work and must have the appropriate admin rights. Pass False for all boolean parameters to demote a user.
     * @param contents Object of the type PromoteChatMemberParams
     * @return Returns Promise of True on success.
     */
    promoteChatMember(contents: PromoteChatMemberParams): Promise<any>;
    /**
     * Use this method to set a custom title for an administrator in a supergroup promoted by the bot.
     * @param contents Object of the type SetChatAdministratorCustomTitleParams
     * @return Returns Promise of True on success.
     */
    setChatAdministratorCustomTitle(contents: SetChatAdministratorCustomTitleParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    setChatPermissions(contents: SetChatPermissionsParams): Promise<any>;
    /**
     ...
     */
    createChatInviteLink(contents: CreateChatInviteLinkParams): Promise<any>;
    /**
     ...
     */
    editChatInviteLink(contents: EditChatInviteLinkParams): Promise<any>;
    /**
     ...
     */
    revokeChatInviteLink(contents: RevokeChatInviteLinkParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    pinChatMessage(contents: PinChatMessageParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    answerCallbackQuery(contents: AnswerCallbackQueryParams): Promise<any>;
    /**
     ...
     * @return Returns Promise of True on success.
     */
    setMyCommands(contents: SetMyCommandsParams): Promise<any>;
    /**
     ...
     */
    editMessageText(contents: EditMessageTextParams): Promise<any>;
    /**
     * Use this method to edit captions of messages.
     * @param contents Object of type EditMessageCaptionParams
     * @return On success, if the edited message is not an inline message, the Promise of the edited Message is returned, otherwise True is returned.
     */
    editMessageCaption(contents: EditMessageCaptionParams): Promise<any>;
    /**
     ...
     */
    answerInlineQuery(contents: AnswerInlineQueryParams): Promise<any>;
}
